...
# iclsutr u=pd.read_csv("/hdd/Ztudy/BTP/code/algoTrials/plotting/outfolders/icluster/expZ_iclust_LGG",sep=' ',header=None).to_numpy()
...
u=pd.read_csv("/hdd/Ztudy/BTP/code/algoTrials/plotting/outfolders/icluster/expZ_iclust_OV",sep=' ',header=None).to_numpy()
...
s=20
ax.scatter3D(u[np.where(tr==1),0],1,1,s=s,marker='o')
ax.scatter3D(u[np.where(tr==2),0],1,1,s=s,marker='v')

# ax.scatter3D(u[np.where(tr==1),0],u[np.where(tr==1),1],1,s=s,marker='o')
# ax.scatter3D(u[np.where(tr==2),0],u[np.where(tr==2),1],1,s=s,marker='v')
# ax.scatter3D(u[np.where(tr==3),0],u[np.where(tr==3),1],1,s=s,marker='s')
# ax.scatter3D(u[np.where(tr==4),0],u[np.where(tr==4),1],1,s=s,marker='p')
